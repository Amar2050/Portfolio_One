 <main onclick="closingNav()">  
        ...
        <!-- Contact -->
            <div id="contact" class="pt-5 pb-5">
                ...
                <form class="border rounded shadow pb-5 pt-5 col-12 col-sm-10 col-md-7 col-lg-6 col-xl-6 m-auto text-center" action="contactForm.php" method="post">
                    ...
                    <textarea class="form-control text-center p-2" type="text" name="message" placeholder="Pensez à communiquer votre numéro de téléphone si vous souhaitez être rappelé"required></textarea><br>
